...
object Utils {
    const val PIZZA_1_TITLE = "Caramelised onion & goat's cheese pizza"
    const val PIZZA_1_DESCRIPTION =
    ...
    const val PIZZA_1_RECIPE =
        "Heat oven to 220C/200C fan/gas 7. Tip the flour into a mixer with a dough hook, or a bowl. Add the yeast, salt, oil and just under 100ml warm water then mix to a soft dough. Knead in the food mixer for about 5 mins, but if making this by hand, tip onto a work surface and knead for about 10 mins. The dough is sticky, but try not to add too much extra flour. Leave in the bowl and cover with a tea towel while you make the topping. There is no need to let the dough prove for a specific time – just let it sit while you get on with the next step.\n" +
                ...
                "\n" +
                "Spread with the spinach followed by the onions, then dot with the cheese and scatter with the olives, thyme and sunflower seeds. Bake for 15 mins until golden and the base is cooked through."
    const val PIZZA_2_TITLE = "BBQ chicken pizza"
    const val PIZZA_2_DESCRIPTION =
    ...
    const val PIZZA_3_TITLE = "Cajun prawn pizza"
    const val PIZZA_3_DESCRIPTION =
    ...
    const val PIZZA_4_TITLE = "Chicken tikka masala pizzas"
    const val PIZZA_4_DESCRIPTION =
    ...
    const val PIZZA_5_TITLE = "Rainbow pizzas"
    const val PIZZA_5_DESCRIPTION =
    ...
    const val PIZZA_6_TITLE = "Pork, gorgonzola & garlic butter pizza"
    const val PIZZA_6_DESCRIPTION =
    ...
    const val PIZZA_7_TITLE = "Spinach & blue cheese pizza"
    const val PIZZA_7_DESCRIPTION =
    ...
    const val PIZZA_8_TITLE = "Pizza Margherita in 4 easy steps"
    const val PIZZA_8_DESCRIPTION =
        "Even a novice cook can master the art of pizza with our simple step-by-step guide. Bellissimo"
    const val PIZZA_8_RECIPE =
    ...
    const val PIZZA_9_TITLE = "Spelt pizza bianco with Jersey Royals"
    const val PIZZA_9_DESCRIPTION =
    ...
    const val PIZZA_10_TITLE = "Frying pan pizza with aubergine, ricotta & mint"
    const val PIZZA_10_DESCRIPTION =
        "This recipe ensures a crispy-bottomed pizza without ever turning on the oven. It's easy, veggie and 2 of your 5-a-day..."
    const val PIZZA_10_RECIPE =
